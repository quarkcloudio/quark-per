...
use QuarkCMS\QuarkAdmin\Http\Requests\QuarkRequest;
...
class CreateModal extends Modal
{
    ...
    public function actions()
    {
        return [
            ...
            Action::make("提交")->reload('table')->type('primary')->actionType('submit')->submitForm('createModalForm')
        ];
    }
}