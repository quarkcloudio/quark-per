...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('menus')->insert([
            ...
            ['id' =>34,'name' => '文件管理','guard_name' => 'admin','icon' => '','pid' => 33,'type'=>'table','sort' => 0,'path' => '/quark/engine?api=admin/file/index&component=table','show'  => 1,'status' => 1],
            ['id' =>35,'name' => '图片管理','guard_name' => 'admin','icon' => '','pid' => 33,'type'=>'table','sort' => 0,'path' => '/quark/engine?api=admin/picture/index&component=table','show'  => 1,'status' => 1],
