...
class InstallCommand extends Command
{
    ...
    public function initDatabase()
    {
        ...
        if (\QuarkCloudIO\QuarkAdmin\Models\Admin::count() == 0) {
    ...
    protected function runDatabaseSeeders()
    {
        ...
        DB::table('configs')->insert([
            ['title' => '网站名称','type' => 'text','name' => 'WEB_SITE_NAME','group_name' => '基本','value' => 'QuarkCloudIO','remark' => '','status' => 1],
            ['title' => '关键字','type' => 'text','name' => 'WEB_SITE_KEYWORDS','group_name' => '基本','value' => 'QuarkCloudIO','remark' => '','status' => 1],
            ['title' => '描述','type' => 'textarea','name' => 'WEB_SITE_DESCRIPTION','group_name' => '基本','value' => 'QuarkCloudIO','remark' => '','status' => 1],
